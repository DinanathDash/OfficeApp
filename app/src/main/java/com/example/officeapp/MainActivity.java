    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (recyclerView != null) {
           ...
           adapter = new RecentFilesAdapter(new ArrayList<>(), new RecentFilesAdapter.OnFileActionListener() {
               @Override
               public void onItemClick(com.example.officeapp.data.RecentFile file) {
                   openFileViewer(file);
               }

               @Override
               public void onShareFile(com.example.officeapp.data.RecentFile file) {
                   shareFile(file);
               }

               @Override
                public void onDeleteFile(com.example.officeapp.data.RecentFile file) {
               ...
               @Override
               public void onDetailsFile(com.example.officeapp.data.RecentFile file) {
                   com.example.officeapp.ui.FileDetailsBottomSheetFragment fragment = 
                       com.example.officeapp.ui.FileDetailsBottomSheetFragment.newInstance(file);
